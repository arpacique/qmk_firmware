...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KC_LSFT,    KC_Z,        KC_X,        KC_C,       KC_V,         KC_B,                    KC_N,  KC_M,        KC_COMM,     KC_DOT,      KC_SLSH,        KC_SFTENT,
                                              KC_LALT,   LOWER,    LT(ARROW, KC_SPC),   RAISE,    KC_RGUI
  ),
  ...
  [_ARROW] = LAYOUT_reviung41(
    _______, _______, _______, KC_UP  , _______, _______,        _______, KC_7, KC_8, KC_9,  KC_SLASH,    KC_BSPC,
    _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______,        _______, KC_4, KC_5, KC_6,  KC_ASTERISK, KC_EQUAL,
    _______, _______, _______, _______, _______, _______,        _______, KC_1, KC_2, KC_3,  KC_MINUS,    KC_PLUS,
